...
function setup() {
	...
	box1Sprite=Bodies.rectangle(400,649,200,20,{isStatic:true});
	World.add(world,box1Sprite)

	box2Sprite=Bodies.rectangle(300,610,20,100,{isStatic:true});
	World.add(world,box2Sprite)

	box3Sprite=Bodies.rectangle(300,610,20,100,{isStatic:true});
